...
DATABASES = {
    'default': {
        ...
        'NAME': path.join(PROJECT_ROOT, 'oi.db'),                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = path.join(PROJECT_ROOT,
                       'media')
...
STATIC_ROOT = "some path in the server"
...
SECRET_KEY = '^db%75jqf(#ov8ma=wpo#az7i*#d-lm#zowif^#5fa91v^t9@2'
