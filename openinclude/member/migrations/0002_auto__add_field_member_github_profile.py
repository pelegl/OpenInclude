...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.github_profile'
        db.add_column('member_member', 'github_profile',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.github_profile'
        db.delete_column('member_member', 'github_profile')
