...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('member_member', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='MemberUser', to=orm['auth.User'])),
            ('github_username', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
