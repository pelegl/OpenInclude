...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tag_projecttag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ProjectTagProject', to=orm['project.Project'])),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ProjectTagTag', to=orm['tag.Tag'])),
        ))
        db.send_create_signal('tag', ['ProjectTag'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('tag_projecttag')
    ...
    models = {
        ...
        'tag.projecttag': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ProjectTagProject'", 'to': "orm['project.Project']"}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ProjectTagTag'", 'to': "orm['tag.Tag']"})
        },
        'tag.tag': {
